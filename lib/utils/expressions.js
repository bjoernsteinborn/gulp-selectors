var selectorName = "(-?[_a-zA-Z0-9@/\\@+-]+[_a-zA-Z0-9@/\\@+-]*)";
...
module.exports = {
   ...
   */
  classSelector: new RegExp(
    "(\\.|\\[class[\\^\\$\\|\\*]?=)" + selectorName + selectorSuffix,
    "gi"
  ),
  idSelector: new RegExp(
    "(#|\\[id[\\^\\$\\|\\*]?=)" + selectorName + selectorSuffix,
    "gi"
  ),
  /**
   ...
   * - href="selector"
   */
  elementAttribute: /(class|id|for|aria-labelledby|CssClass|ExtraClasses)\s*=\s*["']\s*(-?[ _a-zA-Z0-9\@\/\\\@\+\-]+[_a-zA-Z0-9\s\@\/\\\@\+\-]*)["']/g,
  /**
   * Matches ID Values
   *
   ...
   */
  idList: /(?:\$|jQuery|(?:\.(?:getElementById|id|jQuery|attr)))\s*[\(=]{1}\s*(["']{1}#?-?[_a-zA-Z0-9\@\/\\\@\+\-]+[_a-zA-Z0-9\@\/\\\@\+\-]*(?:(?:(?:["']{1}\s*,\s*["']{1})|\s+){1}#?-?[_a-zA-Z0-9\@\/\\\@\+\-]+[_a-zA-Z0-9\@\/\\\@\+\-]*)*["']{1})/,
  /**
   ...
   * .hasClass
   */
  classList: /(?:\$|jQuery|(?:\.(?:getElementsByClassName|classList\.add|classList\.remove|className|jQuery|addClass|toggleClass|removeClass|attr|hasClass)))\s*[\(=]{1}\s*(["']{1}\.?-?[_a-zA-Z0-9\@\/\\\@\+\-]+[_\w-]*(?:(?:(?:["']{1}\s*,\s*["']{1})|\s+){1}\.?-?[_a-zA-Z0-9\@\/\\\@\+\-]+[_a-zA-Z0-9\@\/\\\@\+\-]*)*["']{1})/,
  /**
